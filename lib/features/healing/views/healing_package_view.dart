      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ─── 유튜브 추천 ───
            YouTubeCarousel(videos: _response.youtubeCurated, title: '추천 영상'),
            const SizedBox(height: 24),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            EdenColors.primary.withValues(alpha: isDark ? 0.25 : 0.08),
            EdenColors.accent.withValues(alpha: isDark ? 0.15 : 0.05),
          ],
          begin: Alignment.topLeft, end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(24),
        border: Border.all(color: EdenColors.primary.withValues(alpha: 0.1)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
...
class _VerseCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final verseText = service.getVerseText(verse);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: EdenColors.primary.withValues(alpha: 0.12)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                verse.ref,
                style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: EdenColors.primary),
              ),
            ],
          ),
          const SizedBox(height: 12),
          // 본문
          Text(
            verseText.isNotEmpty ? '"$verseText"' : '"말씀을 불러오는 중..."',
            style: TextStyle(
              fontSize: 17,
              fontStyle: FontStyle.italic,
              height: 1.7,
              color: (isDark ? EdenColors.textPrimaryDark : EdenColors.textPrimaryLight).withValues(alpha: 0.85),
            ),
          ),
            ...
            children: [
              _ActionChip(
                ...
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('구절을 복사했습니다'), behavior: SnackBarBehavior.floating, duration: Duration(seconds: 1)),
                  );
                },
              ),
...
class _PrayerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: EdenColors.accent.withValues(alpha: isDark ? 0.12 : 0.06),
        borderRadius: BorderRadius.circular(20),
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontStyle: FontStyle.italic,
              height: 1.7,
              color: isDark ? EdenColors.textSecondaryDark : EdenColors.textSecondaryLight,
            ),
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(
          label,
          style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: color, letterSpacing: 2),
        ),
      ],
    );
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(icon, size: 14, color: EdenColors.primary),
